...
const A = (m, p, d) => ({ k: 'A', t: 'Warm-Up', m, p, d });
const B = (m, p, d) => ({ k: 'B', t: 'Drill', m, p, d });
const S = (m, p, d) => ({ k: 'B', t: 'Study', m, p, d });
const C = (m, p, d) => ({ k: 'C', t: 'Project', m, p, d });
const R = (p, d) => ({ k: 'D', t: 'Rest & Play', m: 0, p, d });
